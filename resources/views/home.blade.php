        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Dashboard<a href="{{ url('/articles/create') }}"><button class="btn btn-sm btn-success">Create A Blog</button></a>
                </div>
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <a href="/articles/{{ $userArticle->id }}/edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
